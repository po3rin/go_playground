...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/po3rin/tryweaver/Reverser",
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return reverser_client_stub{stub: stub, reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/po3rin/tryweaver/Reverser", Method: "Reverse"})}
		},
