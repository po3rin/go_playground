...
import (
	...
	"github.com/po3rin/try-go-swagger/models"
	...
	"github.com/po3rin/try-go-swagger/restapi/operations"
	"github.com/po3rin/try-go-swagger/restapi/operations/todos"
)
...
//go:generate swagger generate server --target ../../try-go-swagger --name TodoList --spec ../swagger.yml
